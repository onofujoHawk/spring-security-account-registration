...
<title>Magister &raquo; 403 Access denied</title>
		...
		<div class="container">
			<div class="row">
				<div
					...
					<h1 class="403page">403</h1>
					<h2 class="subtitle">Access is denied</h2>
					<p>
						<a class="btn btn-default btn-lg" href="${contextPath}/index">Back</a>
					</p>
				</div>
				<!-- /col -->
			</div>
